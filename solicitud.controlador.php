...
class SolicitudControlador
{
    ...
    public function ctrNuevaSolicitudEmp()
    {
        if (isset($_POST['btnEnviarSolicitud'])) {
            ...
            $sld_sexo = isset($_POST['sld_sexo']) ? $_POST['sld_sexo'] : '';
            $sld_lugarnacim = $_POST['sld_lugarnacim'];
            $sld_fechanacim = $_POST['sld_fechanacim'];
            $sld_nacionalidad = isset($_POST['sld_nacionalidad']) ? $_POST['sld_nacionalidad'] : '';
            $sld_vive_con = isset($_POST['sld_vive_con']) ? $_POST['sld_vive_con'] : '';
            $sld_estado_civil = isset($_POST['sld_estado_civil']) ? $_POST['sld_estado_civil'] : '';
            ...
            $sld_licencia = isset($_POST['sld_licencia']) ? $_POST['sld_licencia'] : '';
            ...
            //radiob 
            $sld_salud_estado = isset($_POST['sld_salud_estado']) ? $_POST['sld_salud_estado'] : '';
            
            $sld_enf_cronica = isset($_POST['sld_enf_cronica']) ? $_POST['sld_enf_cronica'] : '';
            ...
            $sld_est_vida_padre = isset($_POST['sld_est_vida_padre']) ? $_POST['sld_est_vida_padre'] : '';
            $sld_dir_padre = $_POST['sld_dir_padre'];
            $ocup_padre = $_POST['sld_ocup_padre'];


            $sld_nom_madre = $_POST['sld_nom_madre'];
            $sld_est_vida_madre = isset($_POST['sld_est_vida_madre']) ? $_POST['sld_est_vida_madre'] : '';
            $sld_dir_madre = $_POST['sld_dir_madre'];
            $sld_ocup_madre = $_POST['sld_ocup_madre'];


            $sld_nom_espos = $_POST['sld_nom_espos'];
            $sld_est_vida_espos = isset($_POST['sld_est_vida_espos']) ? $_POST['sld_est_vida_espos'] : '';
            ...
            $sld_soli_info = isset($_POST['sld_soli_info']) ? $_POST['sld_soli_info'] : '';
            ...
            //-------------DATOS GENERALES------------------------
            $sld_como_se_entero_rb = isset($_POST['sld_como_se_entero_rb']) ? $_POST['sld_como_se_entero_rb'] : '';
            $sld_como_se_entero = $_POST['sld_como_se_entero'];
            $sld_pariente_en_la_empresa = isset($_POST['sld_pariente_en_la_empresa']) ? $_POST['sld_pariente_en_la_empresa'] : '';
            $sld_nombre_pariente_empresa = $_POST['sld_nombre_pariente_empresa'];
            $sld_afianzado = isset($_POST['sld_afianzado']) ? $_POST['sld_afianzado'] : '';
            $sld_nombre_cia = $_POST['sld_nombre_cia'];
            $sld_sindicato = isset($_POST['sld_sindicato']) ? $_POST['sld_sindicato'] : '';
            $sld_nombre_sindicato = $_POST['sld_nombre_sindicato'];
            $sld_segurovida = isset($_POST['sld_segurovida']) ? $_POST['sld_segurovida'] : '';
            $sld_segurovida_cia = $_POST['sld_segurovida_cia'];
            $sld_segurovida_suma = $_POST['sld_segurovida_suma'];
            $sld_podria_viajar = isset($_POST['sld_podria_viajar']) ? $_POST['sld_podria_viajar'] : '';
            $sld_podria_viajar_razones = $_POST['sld_podria_viajar_razones'];
            $sld_dispuesto_cambiar_residencia = isset($_POST['sld_dispuesto_cambiar_residencia']) ? $_POST['sld_dispuesto_cambiar_residencia'] : '';
            ...
            $data_json_array = array(
                ...
                'datos_personales_json' => $datos_personales_json,
            ...
            $data_json_array = SolicitudModelo::mdlNuevaSolicitudEmp($data_json_array);
        }
    }
}
